...
public class TotalStatistic implements Callable<Vector>{
    String link,cat;
   ...
   double totalPointerKL, totalPointerNS,totalPointerPP,totalPointerPAHANG,totalPointerPTRJAYA,totalPointerPERAK,totalPointerSELANGOR,totalPointerJOHOR,
            totalPointerKEDAH, totalPointerSRW,totalPointerSB,totalPointerMLK,totalPointerKLT;
    public static Vector<Pair<Double,String>> subTotal = new Vector<Pair<Double,String>>();


    public TotalStatistic(String link){
    ...
    public Pair[] getTwo(String url) {
        ...
        return new Pair []{new Pair<>(totalPointerKL,cat),new Pair<>(totalPointerNS,cat), new Pair<>(totalPointerPP,cat),new Pair<>(totalPointerPAHANG,cat),
                ...
                new Pair<>(totalPointerKEDAH,cat),new Pair<>(totalPointerSRW,cat),new Pair<>(totalPointerSB,cat),new Pair<>(totalPointerMLK,cat),new Pair<>(totalPointerKLT,cat)};
    }
}
