...
public class MainClass {
    ...
    public static void main (String[] args) throws IOException {
        ...
        Path path1 = Paths.get("C:\\Users\\Tyjia\\Desktop\\url.txt"); //change your path
        List<String> line = null;
        line = Files.readAllLines(path1);

        //save valid link
        File file = new File("C:\\Users\\Tyjia\\Desktop\\validURL.txt");
        ...
        displayTop3 display = new displayTop3();
        display.run();
